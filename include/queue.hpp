 ...
 * Last Modified Date: 31.03.2021 23:19
...
public:
    PriorityQueue() {}
    PriorityQueue(T1 first_element) : q_root{QueueNode<T1>(first_element)} {}

    PriorityQueue<T1> *push(T1 i) { q_root = _push(q_root, i); return (this); }
    QueueNode<T1>     *pop()      { return(_pop(q_root)); }
